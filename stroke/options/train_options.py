...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--tensorboard_folder', type=str, default='./tensorbord/places2_stroke_MLD_LW_bigmask_haveallLL/', help='tensorbord are saved here')
        ...
        self.parser.add_argument('--use_style_loss', type=int, default=0)        

        self.parser.add_argument('--train_spe', type=int, default=10000)
        self.parser.add_argument('--max_iters', type=int, default=50000)
