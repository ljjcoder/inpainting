...
class TestOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--load_model_dir1', type=str, default='./checkpoints', help='pretrained models are given here')
        #added by ljj
        self.parser.add_argument('--load_multi_model_dir', type=str, nargs=2, default='./checkpoints', help='pretrained models are given here')
        #added end            
        ...
        self.parser.add_argument('--mask_id', type=int, default=0)        
        ...
        self.parser.add_argument('--save_root1', type=str, default='./test_results/author_fid/',
                                 help='# of discriminator filters in first conv layer')
        self.parser.add_argument('--save_root2', type=str, default='./test_results/places2_stoke_bigmask_fid/',
                                 help='# of discriminator filters in first conv layer')                                 
    ...
    def parse(self):
        ...
        if os.path.exists(self.opt.save_root2) is False and self.opt.mode == 'save':
            os.mkdir(self.opt.save_root2)
