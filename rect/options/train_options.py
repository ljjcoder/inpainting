...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--tensorboard_folder', type=str, default='/output/places2/', help='tensorbord are saved here')
        ...
        self.parser.add_argument('--use_all_var', type=int, default=0, help='0 means CA var use random initial') 
        self.parser.add_argument('--use_CA_max', type=int, default=0, help='0 means not use CA_max layer')         

        self.parser.add_argument('--train_spe', type=int, default=10000)
        self.parser.add_argument('--max_iters', type=int, default=400000)
        self.parser.add_argument('--viz_steps', type=int, default=5000)
        ...
        self.parser.add_argument('--vgg19_path', type=str, default='/home/lijunjie/inpainting_gmcnn-master/tensorflow_MLD/vgg19_weights/imagenet-vgg-verydeep-19.mat')
    ...
    def parse(self):
        ...
        if os.path.isdir(self.opt.tensorboard_folder) is False:
            os.mkdir(self.opt.tensorboard_folder)  
        args = vars(self.opt)
