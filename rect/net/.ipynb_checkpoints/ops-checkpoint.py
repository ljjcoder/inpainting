...
def free_form_mask_tf(parts, maxVertex=16, maxLength=60, maxBrushWidth=14, maxAngle=360, im_size=(256, 256), name='fmask'):
    ...
    filter=np.zeros([8,8,1]).astype(dtype=np.float32)
...
class Vgg19(object):
    def __init__(self, filepath=None):
        ...
        self.vgg_weights = filepath if filepath is not None else os.path.join('/model/hnljj/gmcc-vgg19/vgg19_weights', 'imagenet-vgg-verydeep-19.mat')
