...
from net.ops import gan_wgan_loss, gradients_penalty, random_interpolates,bbox2mask_board_random
...
class GMCNNModel:
    ...
    def build_net(self, batch_data, config, summary=True, reuse=False):
        ...
        if config.mask_type == 'rect':
            ...
            mask_center= bbox2mask_board_random(bbox,h-8,w-8, config, name='mask_center')            
